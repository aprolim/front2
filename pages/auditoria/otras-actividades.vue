  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="container mx-auto px-4 max-w-[90vw] py-[6vw] sm:py-8">
      ...
      <div v-if="loading" class="flex justify-center items-center py-[12vw] sm:py-20">
        ...
        <p class="ml-4 text-gray-500 text-[3vw] sm:text-sm">Cargando actividades...</p>
      </div>
...
const MODULO = 'otras-actividades'
...
const totalActividades = computed(() => documentos.value.length)
...
const cargarDatos = async () => {
  ...
  try {
    ...
    if (result.success && result.data) {
      ...
      console.log(`✅ [Otras Actividades] ${categorias.value.length} categorías, ${documentos.value.length} documentos`)
    } else {
    ...
    console.error('❌ [Otras Actividades] Error:', err)
  } finally {
    loading.value = false
  }
}
