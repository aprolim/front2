<template>
  <div class="py-[6vw] sm:py-8">
    <div v-if="suplente" class="w-[92%] sm:w-[80%] mx-auto">
      <!-- Botón volver -->
      <button 
        @click="volver"
        class="inline-flex items-center text-senado-primary hover:underline mb-[3vw] sm:mb-4 text-[3.3vw] sm:text-[1.1vw] cursor-pointer"
      >
        ← Volver atras
      </button>
        ...
        <div class="bg-[#EDEEED]">
          <div class="grid grid-cols-1 sm:grid-cols-12 border-b border-gray-200 w-[92%] sm:w-[80%] mx-auto gap-[2vw] sm:gap-0">
            ...
            <div class="sm:col-span-6 py-[3vw] sm:py-[1.2vw] sm:ml-[-1vw] flex flex-col justify-center text-center sm:text-left">
              ...
              <p v-if="suplente.cargo && suplente.cargo !== 'No disponible'" class="font-semibold text-[3vw] sm:text-[1.0vw] leading-tight">
                {{ suplente.cargo }}
              </p>
            </div>
            ...
            <div class="space-y-[3vw] sm:space-y-[1.4vw] text-[2.7vw] sm:text-[0.9vw]">
              ...
              <div class="grid grid-cols-[40%_60%]">
                ...
                <div class="flex gap-[1.5vw] sm:gap-1 flex-wrap">
                  <a v-if="suplente.facebook" :href="suplente.facebook" target="_blank" rel="noopener noreferrer" class="w-[3.5em] sm:w-[2.5em] h-[3.5em] sm:h-[2.5em] rounded-full bg-black flex items-center justify-center hover:bg-gray-800 transition-colors">
                  ...
                  <a v-if="suplente.twitter" :href="suplente.twitter" target="_blank" rel="noopener noreferrer" class="w-[3.5em] sm:w-[2.5em] h-[3.5em] sm:h-[2.5em] rounded-full bg-black flex items-center justify-center hover:bg-gray-800 transition-colors">
                  ...
                  <a v-if="suplente.instagram" :href="suplente.instagram" target="_blank" rel="noopener noreferrer" class="w-[3.5em] sm:w-[2.5em] h-[3.5em] sm:h-[2.5em] rounded-full bg-black flex items-center justify-center hover:bg-gray-800 transition-colors">
                  ...
                  <a v-if="suplente.youtube" :href="suplente.youtube" target="_blank" rel="noopener noreferrer" class="w-[3.5em] sm:w-[2.5em] h-[3.5em] sm:h-[2.5em] rounded-full bg-black flex items-center justify-center hover:bg-gray-800 transition-colors">
                  ...
                  <a v-if="suplente.tiktok" :href="suplente.tiktok" target="_blank" rel="noopener noreferrer" class="w-[3.5em] sm:w-[2.5em] h-[3.5em] sm:h-[2.5em] rounded-full bg-black flex items-center justify-center hover:bg-gray-800 transition-colors">
          ...
          <div class="p-[3vw] sm:p-[1.2vw] flex flex-col justify-center">
            ...
            <div class="flex flex-col items-center">
              <img 
                ...
                @error="(e) => e.target.src = ''"
              />
              <span class="text-[3vw] sm:text-[1vw] font-bold text-senado-primary text-right w-full translate-y-[-4vw] sm:translate-y-[-2vw]">Asiento {{ suplente.seatNumber }}</span>
            </div>
          </div>
        </div>
      </div>
